    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-brand-blue tracking-tight leading-tight">
              ...
              <div className="bg-brand-blue/5 rounded-2xl p-6 border border-brand-blue/10">
                <h4 className="font-bold text-brand-blue flex items-center mb-3">
            ...
            <div className="lg:col-span-6">
              <h3 className="text-xl font-bold text-brand-blue mb-6 border-b border-gray-100 pb-3">
                What We Do
              </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-20 pt-16 border-t border-gray-100">
            {/* Timeline */}
            <div className="lg:col-span-6 space-y-6">
              <h3 className="text-xl font-bold text-brand-blue flex items-center mb-6">
              ...
              <div className="space-y-6 relative border-l-2 border-brand-blue/15 pl-6 ml-3">
                {adsTimeline.map((item, idx) => (
                  <div key={idx} className="relative">
                    ...
                    <h4 className="font-bold text-brand-blue text-base">{item.title}</h4>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-5">
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                  <h4 className="font-bold text-brand-blue text-sm">What's the minimum budget?</h4>
                ...
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                  <h4 className="font-bold text-brand-blue text-sm">Will my ads show up immediately?</h4>
                  <p className="text-xs text-gray-600 mt-2 leading-relaxed">
                ...
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                  <h4 className="font-bold text-brand-blue text-sm">How do you ensure good ROI?</h4>
                  <p className="text-xs text-gray-600 mt-2 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-20 pt-16 border-t border-gray-100">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-5">
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                  <h4 className="font-bold text-brand-blue text-sm">How long until I rank in Google Maps?</h4>
                  <p className="text-xs text-gray-600 mt-2 leading-relaxed">
                ...
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                  <h4 className="font-bold text-brand-blue text-sm">Do I need a physical storefront?</h4>
                  <p className="text-xs text-gray-600 mt-2 leading-relaxed">
                ...
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-100">
                  <h4 className="font-bold text-brand-blue text-sm">What if my business has negative reviews?</h4>
                  <p className="text-xs text-gray-600 mt-2 leading-relaxed">
      ...
      <section id="comparison" className="py-20 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mt-12 bg-brand-blue/5 p-6 rounded-2xl border border-brand-blue/10">
            <h4 className="font-bold text-brand-blue mb-2 text-base">Our Recommendation</h4>
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-100 text-center">
        <div className="max-w-3xl mx-auto px-4 space-y-6">
          <h3 className="text-2xl font-bold text-brand-blue">Not Sure Which Service You Need?</h3>

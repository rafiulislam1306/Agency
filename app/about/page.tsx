      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-6 mb-16">
          <div className="inline-flex items-center space-x-2 text-xs font-bold uppercase tracking-wider text-brand-blue bg-brand-blue/10 px-3 py-1 rounded-md">
            <Compass className="w-4 h-4 mr-1 text-brand-blue" aria-hidden="true" />
            Our Mission
          </div>
            ...
            <div className="md:col-span-8 space-y-6">
              {[
                ...
                <div key={idx} className="flex items-start">
                  <CheckCircle2 className="w-5 h-5 text-brand-green mr-4 mt-0.5 flex-shrink-0" aria-hidden="true" />
                  <div>

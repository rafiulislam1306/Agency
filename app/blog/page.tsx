    ...
    <div className="bg-white min-h-screen pt-28 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-brand-blue tracking-tight leading-tight">
        ...
        <div className="space-y-6 mb-16">
          <h2 className="text-xl font-bold text-brand-blue border-b border-gray-100 pb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {upcomingPosts.map((post, idx) => (
              <div key={idx} className="border border-gray-100 rounded-2xl p-6 bg-white shadow-xs hover:shadow-sm transition-all">
                ...
                <h3 className="font-bold text-brand-blue text-lg mt-3 leading-snug">
                  {post.title}
                </h3>
        ...
        <div className="bg-brand-blue/5 border border-brand-blue/10 rounded-3xl p-8 sm:p-10 text-center space-y-6">
          <h3 className="text-xl sm:text-2xl font-bold text-brand-blue">Want to See These Optimization Steps Implemented Live?</h3>
